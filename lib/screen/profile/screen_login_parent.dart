...
class ScreenLoginParent extends StatefulWidget {
  const ScreenLoginParent({Key? key}) : super(key: key);

  @override
  State<ScreenLoginParent> createState() => _ScreenLoginParentState();
}

class _ScreenLoginParentState extends State<ScreenLoginParent> {
